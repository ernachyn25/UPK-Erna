...
<div class="wrap">
	...
	<div class="menu">
		...
		<a href="index.php?resto=pelanggan"><div class="list-menu">Pelanggan</div></a>
		<a href="index.php?resto=meja"><div class="list-menu">meja</div></a>
	 ...
	 <div class="list-menu2">WELCOME <?php echo $_SESSION['useraktif'] ?>Administrator
	 </div>
